...
class AmbienceRepositoryImpl(
    ...
    override suspend fun getAmbiences(): DonaResult<List<Ambience>> = donaResultCatching {
    ...
    override suspend fun triggerAmbience(id: Int, run: Boolean): DonaResult<Unit> {
        val raw = rawAmbienceCache[id]
