...
class DeviceRepositoryImplTest {
    ...
    @Test
    fun `sending a command for a device that was never read fails without calling the api`() = runTest {
    ...
    @Test
    fun `sending a command after reading the device forwards the cached raw json`() = runTest {
